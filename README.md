...
update: there is also a version that does not require any local installations, instead it calls an API from replicate.com
https://github.com/SerjoschDuering/StableDiffusion-GrasshopperCLOUD
